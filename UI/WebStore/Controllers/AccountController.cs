...
namespace WebStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel Model)
        {
            ...
            {
                //_Logger.LogInformation($"Успешный вход в систему {Model.UserName}"); // так делать не надо!
            ...
            _Logger.LogWarning("Ошибка ввода пользователя или пароля {0}", Model.UserName);
        ...
        public IActionResult AccessDenied()
        {
            ...
            _Logger.LogWarning("В доступе отказано пользователю {0} по поути {1}",
                user_name, ControllerContext.HttpContext.Request.Path);
